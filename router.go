...
// Params is a map of name/value pairs for named routes. An instance of moon.Params is available to be injected into any route handler.
type Params map[string]string

// Router is Dacheng's de-facto routing interface. Supports HTTP verbs, stacked handlers, and dependency injection.
type Router interface {
	...
	// Handle is the entry point for routing. This is used as a moon.Handler
...
// Route is an interface representing a Route in Dacheng's routing layer.
...
// Routes is a helper service for Dacheng's routing layer.
